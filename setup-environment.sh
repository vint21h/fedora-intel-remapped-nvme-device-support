...
KERNEL_PATCH_FILE_NAME="patch-intel-remapped-nvme-device-support.patch";  # kernel patch file name
KERNEL_PATCH_PATH="${KERNEL_BUILD_DIR_PATH}/${KERNEL_PATCH_FILE_NAME}";  # kernel patch path
...
FEDORA_KICKSTARTS_PATH="${BUILD_DIR_PATH}/fedora-kickstarts";  # Fedora kickstarts files path
FEDORA_KICKSTART_FILE_NAME="flat-fedora-live-workstation.ks";  # Fedora flatten kickstart file name
FEDORA_KICKSTART_FILE_PATH="${FEDORA_KICKSTARTS_PATH}/${FEDORA_KICKSTART_FILE_NAME}";  # Fedora flatten kickstart file path
...
export FEDORA_KICKSTARTS_PATH;
export FEDORA_KICKSTART_FILE_NAME;
export FEDORA_KICKSTART_FILE_PATH;
